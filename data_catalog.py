...
DATASETS: tuple[DatasetSpec, ...] = (
    ...
    DatasetSpec("Sale lines (30d)", "sale_lines_last_30d", "CIN7 sales", 24, "python cin7_sync.py salelines --days 30"),
    DatasetSpec("Sale lines (3d)", "sale_lines_last_3d", "CIN7 sales", 24, "python cin7_sync.py salelines --days 3"),
    DatasetSpec("Purchase lines (90d)", "purchase_lines_last_90d", "CIN7 purchasing", 168, "python cin7_sync.py purchaselines --days 90"),
    DatasetSpec("BOMs", "boms", "CIN7 production", 168, "python cin7_sync.py boms"),
    DatasetSpec("Assemblies", "assemblies_last_365d", "CIN7 production", 168, "python cin7_sync.py assemblies --days 365"),
    ...
    DatasetSpec("Shopify orders", "shopify_orders_last_30d", "Shopify", 24, "python shopify_sync.py daily --days 30"),
    DatasetSpec("Inventory Planner notes", "ip_notes", "Inventory Planner", 24, "python ip_probe.py notes"),
